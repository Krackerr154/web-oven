...
import { addUserGlassware } from "@/app/actions/glassware";
import { Beaker, Save, Loader2, ArrowLeft } from "lucide-react";
import Link from "next/link";
import { useToast } from "@/components/toast";

export default function AddUserGlasswareClient() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await addUserGlassware({ ...formData, quantity: quantityNum });
            if (res.success) {
                toast.success("Private Glassware Added!");
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                        ...
                        Add Private Glassware
                    </h1>
                    <p className="text-slate-400 mt-1 text-sm">
                        Log your personal laboratory glassware. Other users can contact you to borrow it.
                    </p>
                </div>
            </div>
