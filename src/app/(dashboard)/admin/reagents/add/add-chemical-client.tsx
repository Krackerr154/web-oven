...
import { addLabChemical, fetchPubChemSynonyms } from "@/app/actions/reagents";
...
export default function AddAdminChemicalClient() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (
            ...
            toast.error("Please fill in all mandatory table fields.");
            return;
        }

        setIsSubmitting(true);
        try {
            const res = await addLabChemical(formData);
            if (res.success) {
                toast.success("Chemical added to Lab Inventory!");
    ...
    return (
        <div className="max-w-2xl mx-auto animate-fade-in space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-white flex items-center gap-2">
                        ...
                        Add Lab-Owned Chemical
                    </h1>
                    <p className="text-slate-400 mt-1 text-sm">
                        Chemicals added here will be marked as "Lab Owned" and visible to all users.
                    </p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-slate-900/50 backdrop-blur-md rounded-2xl border border-slate-700/50 p-6 space-y-6 shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 outline-none transition-all"
                    ...
                    <div className="space-y-2">
                        ...
                        <select
                            ...
                            className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 outline-none transition-all appearance-none"
                        >
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-medium text-slate-300">Catalog Number (No. katalog) *</label>
                        <input
                            type="text"
                            required
                            value={formData.catalogNo}
                            onChange={(e) => setFormData({ ...formData, catalogNo: e.target.value })}
                            className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 outline-none transition-all"
                            placeholder="e.g. 1.00063.2500"
                        />
                    </div>
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Storage Location (Posisi) *</label>
                    <input
                        type="text"
                        required
                        ...
                        className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 outline-none transition-all"
                        placeholder="e.g. Cabinet A, Shelf 2, Fridge"
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        rows={3}
                        className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 outline-none transition-all resize-none"
                        placeholder="Any special handling instructions, purity, etc."
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        rows={2}
                        className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 outline-none transition-all resize-none text-sm"
                ...
                <div className="pt-4 flex justify-end">
                    ...
                    >
                        ...
                        {isSubmitting ? "Saving..." : "Save Chemical to Inventory"}
                    </button>
                </div>
            </form>
        </div>
