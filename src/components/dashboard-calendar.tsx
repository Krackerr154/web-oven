        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm font-medium text-slate-200 w-36 text-center" aria-live="polite">
                                    ...
                                    <div className="flex items-center gap-1.5 w-full">
                                        ...
                                        {det.userPhone && (
                                            <a
                                                ...
                                                aria-label={`Chat with ${det.userName} on WhatsApp`}
                                                className="ml-auto text-green-500 hover:text-green-400 transition-colors shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 rounded-sm"
