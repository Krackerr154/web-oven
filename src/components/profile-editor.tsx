            ...
            <div className="flex flex-col items-center text-center relative">
                ...
                {!isEditing && (
                    <button
                        ...
                        className={cn(
                            "absolute top-0 right-0 p-2 text-slate-400 rounded-lg transition-colors",
                ...
                <div className="relative group mb-4">
                    <div className="h-20 w-20 rounded-full bg-orange-500/20 border-2 border-orange-500/30 overflow-hidden flex items-center justify-center relative shadow-lg">
                        ...
                        <button
                            ...
                            className={cn(
                                "absolute inset-0 bg-black/60 opacity-0 transition-opacity flex flex-col justify-center items-center text-white cursor-pointer",
